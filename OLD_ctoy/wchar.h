...
#include "libc-header-start.h" /* quotes for local file for CToy */
/* Gather machine dependent type support.  */
/*#include <bits/floatn.h>*/
#include "floatn.h" /* bao: quotes for local file for CToy */
...
#include "bits-wchar.h" /* bao: quotes for local file for CToy */
/*#include <bits/types/wint_t.h>*/
#include "wint_t.h" /* bao: quotes for local file for CToy */
/*#include <bits/types/mbstate_t.h>*/
#include "mbstate_t.h" /* bao: quotes for local file for CToy */
/*#include <bits/types/__FILE.h>*/
#include "__FILE.h" /* bao: quotes for local file for CToy */
#if defined __USE_UNIX98 || defined __USE_XOPEN2K
/*# include <bits/types/FILE.h>*/
# include "FILE.h" /* bao: quotes for local file for CToy */
#endif
#ifdef __USE_XOPEN2K8
/*# include <bits/types/locale_t.h>*/
# include "locale_t.h" /* bao: quotes for local file for CToy */
#endif
