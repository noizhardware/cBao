...
#define FLOATX_VERSION "2022j07-1349"
...
/*** TYPEDEFS */
	...
	/* Check if built-in float is equivalent to float16_t, float32_t, float64_t, float96_t, or float128_t. */
		...
		/*size_t FLOATX_SIZEOF_FLOAT = sizeof(float);*/
		#if  ((FLT_MANT_DIG == 11) && (FLT_MAX_EXP == 16) && (FLOATX_HAS_FLOAT16_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_FLOAT == 2)*/)
		...
		#elif((FLT_MANT_DIG == 24) && (FLT_MAX_EXP == 128) && (FLOATX_HAS_FLOAT32_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_FLOAT == 4)*/)
		...
		#elif((FLT_MANT_DIG == 53) && (FLT_MAX_EXP == 1024) && (FLOATX_HAS_FLOAT64_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_FLOAT == 8)*/)
		...
		#elif((FLT_MANT_DIG == 64) && (FLT_MAX_EXP == 16384) && (FLOATX_HAS_FLOAT96_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_FLOAT == 12)*/)
		...
		#elif((FLT_MANT_DIG == 113) && (FLT_MAX_EXP == 16384) && (FLOATX_HAS_FLOAT128_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_FLOAT == 16)*/)
	...
	/* Check if built-in double is equivalent to float16_t, float32_t, float64_t, float96_t, or float128_t. */
		...
		/*size_t FLOATX_SIZEOF_DOUBLE = sizeof(double);*/
		#if  ((DBL_MANT_DIG == 11) && (DBL_MAX_EXP == 16) && (FLOATX_HAS_FLOAT16_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_DOUBLE == 2)*/)
		...
		#elif((DBL_MANT_DIG == 24) && (DBL_MAX_EXP == 128) && (FLOATX_HAS_FLOAT32_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_DOUBLE == 4)*/)
		...
		#elif((DBL_MANT_DIG == 53) && (DBL_MAX_EXP == 1024) && (FLOATX_HAS_FLOAT64_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_DOUBLE == 8)*/)
		...
		#elif((DBL_MANT_DIG == 64) && (DBL_MAX_EXP == 16384) && (FLOATX_HAS_FLOAT96_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_DOUBLE == 12)*/)
		...
		#elif((DBL_MANT_DIG == 113) && (DBL_MAX_EXP == 16384) && (FLOATX_HAS_FLOAT128_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_DOUBLE == 16)*/)
	...
	/* Check if built-in long double is equivalent to float16_t, float32_t, float64_t, float96_t, or float128_t. */
		...
		/*size_t FLOATX_SIZEOF_LONGDOUBLE = sizeof(long double);*/
		#if  ((LDBL_MANT_DIG == 11) && (LDBL_MAX_EXP == 16) && (FLOATX_HAS_FLOAT16_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_LONGDOUBLE == 2)*/)
		...
		#elif((LDBL_MANT_DIG == 24) && (LDBL_MAX_EXP == 128) && (FLOATX_HAS_FLOAT32_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_LONGDOUBLE == 4)*/)
		...
		#elif((LDBL_MANT_DIG == 53) && (LDBL_MAX_EXP == 1024) && (FLOATX_HAS_FLOAT64_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_LONGDOUBLE == 8)*/)
		...
		#elif((LDBL_MANT_DIG == 64) && (LDBL_MAX_EXP == 16384) && (FLOATX_HAS_FLOAT96_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_LONGDOUBLE == 12)*/)
		...
		#elif((LDBL_MANT_DIG == 113) && (LDBL_MAX_EXP == 16384) && (FLOATX_HAS_FLOAT128_NATIVE_TYPE == 0) /*&& (FLOATX_SIZEOF_LONGDOUBLE == 16)*/)
